                            ...
                            <div class="ps-product__thumbnail">
                                <div class="ps-product__preview">
                                    <div class="ps-product__variants">
                                        ...
                                        <div class="item"><img src="images/shoe-detail/3.jpg" alt="" /></div>
                                        <div class="item"><img src="images/shoe-detail/3.jpg" alt="" /></div>
                                    </div><a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src={detail} alt="" /><i class="fa fa-play"></i></a>
                                </div>
                                <div class="ps-product__image">
                                    <div class="item"><img class="zoom" src={detail} alt="" data-zoom-image={detail} /></div>
                                </div>
                            </div>
                            <div class="ps-product__thumbnail--mobile">
                                <div class="ps-product__main-img"><img src={detail} alt="" /></div>
